...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        public float RotationSpeedQE = 180f;
        ...
        private void Update()
        {
            ...
            // 🔥 INPUT MANUAL (PLAN B)
            _input.move = new Vector2(Input.GetAxis("Horizontal"), Input.GetAxis("Vertical"));
        ...
        private void Move()
        {
            bool sprinting = _isSprinting && _input.move != Vector2.zero;
            ...
            if (rotationInput != 0f)
            {
                float rotation = transform.eulerAngles.y + rotationInput * RotationSpeedQE * Time.deltaTime;
